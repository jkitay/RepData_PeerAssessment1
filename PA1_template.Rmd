...
* The difference between total number of steps between imputed and non-imputed data is `r total_diff`. As such, there were `r total_diff` more steps in the imputed data.
